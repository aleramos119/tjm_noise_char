...
args=["test/optimization/cpu_traj_scan/32_cpus_4096_traj", 100, 3]
...
loss_function.set_file_name(f"{folder}/loss_x_history")
...
#%%
loss_function.reset()
loss_history, x_history, x_avg_history, t_opt, exp_val_traj= ADAM_loss_class(loss_function, x0, alpha=0.02, max_iterations=1000, threshhold = 5e-4, max_n_convergence = 50, tolerance=1e-8, beta1 = 0.5, beta2 = 0.99, epsilon = 1e-8)#, Ns=10e5)
